CREATE DATABASE  IF NOT EXISTS `maketnow` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `maketnow`;
-- MySQL dump 10.13  Distrib 8.0.17, for Win64 (x86_64)
--
-- Host: localhost    Database: maketnow
-- ------------------------------------------------------
...
INSERT INTO `categories` VALUES (1,'aaaaaaaaaaaa',1),(2,'aaaaaaaaaaa',2);
...
CREATE TABLE `order_items` (
  ...
  `order_item_status_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `permissions` (
  ...
  `action` enum('READ') COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-11-21 22:10:50
